...
image1 = Image.open('/Users/rajeevjoshi/Microsoft engage/WebsiteLogo2.jpg')
with col1:
...
with col1:
    ...
    with col2:
        button5 = st.button('About Me')

if ((button3 != True) & (button5 != True)):
    col1, col2 = st.columns([1, 4])
    logo = Image.open('/Users/rajeevjoshi/Microsoft engage/WebsiteLogo.png')
    col1.image(logo, width=200)
    engage = Image.open('/Users/rajeevjoshi/Microsoft engage/image001.jpg')
    col2.image(engage, width=900)

    data = pd.read_csv("/Users/rajeevjoshi/Microsoft engage/Cleaned Engage Car.csv")
...
if button3:
    ...
    st.image('/Users/rajeevjoshi/Microsoft engage/top7sevenmanufacturer.png', width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/countplotonroadprice.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/countplotbodytype.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/countplotfueltype.png',width = 600)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/countplotdisplacement.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/scatterplotdisplacementpower.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/scatterplotonroadpricepower.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/fueltypemileageplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/geartypemileageplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/mileagegeartypestripplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/cylinderpowerkdeplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/drivetrainmileageplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/drivetrainonroadpricestripplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/mileagedrivetrainstripplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/drivetrainpowerswarmplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/powermileagefueltypeplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/mileagepowermanufacturerscatterplot.png',width = 900)
    ...
    st.image('/Users/rajeevjoshi/Microsoft engage/datadescribe1.png',width = 900)
    ...
    st.image('/Users/rajeevjoshi/Microsoft engage/manufactureronroadpricelineplot.png',width = 900)
    ...
    st.write("\n")
    st.image('/Users/rajeevjoshi/Microsoft engage/manufacturermileagelineplot.png',width = 900)
    st.markdown("INSIGHTS :\n")
...
if button5:
    st.header("ABOUT ME")
    st.write("My name is RAJEEV LOCHAN JOSHI")
    st.write("I am currently pursuing my undergraduation in Mechanical Engineering from Indian Institute of Technology Kharagpur.")
    st.write("I belong to Naintal, Uttarakhand")
    st.write("I am a Machine Learning enthusiast and I love playing with data. I have keen interest in Probability, Statistics and Linear Algebra")
    st.write("I am a professional Cricket Player and was part of U-16 Uttarakhand Cricket Team and was there in camp for U-19 Team")
    st.write("I was also honored by Chief Minister of Uttarakhand for excelence in State Board Exams in 2017")
    st.write("In one go , I would say that I have hunger for knowledge and determination, to turn information into action")
    st.markdown("Contact : joshirajeev1815@gmail.com")
